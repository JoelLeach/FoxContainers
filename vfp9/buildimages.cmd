...
@echo ================================================
docker image build --build-arg VFPTag=ltsc2022 --tag vfp9:ltsc2022 .

@echo ================================================
@echo Building Windows 20H2 image...
@echo ================================================
docker image build --build-arg VFPTag=20H2 --tag vfp9:20H2 .

@echo ================================================
@echo Building Windows Server 2019 1809 (LTSC) image...
@echo ================================================
docker image build --build-arg VFPTag=1809 --tag vfp9:1809 .